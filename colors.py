        ...
        for c in chars:
            if not c in color_dict:
                ...
                if c == 'A':
                    ...
                    color_dict[c] = to_rgb('bisque')
                elif c == 'C':
                    color_dict[c] = to_rgb('forestgreen')
                elif c == 'D':
                    color_dict[c] = to_rgb('slategrey')
                elif c == 'E':
                    color_dict[c] = to_rgb('darkgray')
                elif c == 'F':
                    color_dict[c] = to_rgb('lime')
                elif c == 'G':
                    color_dict[c] = to_rgb('navy')
                elif c == 'H':
                    color_dict[c] = to_rgb('snow')
                elif c == 'I':
                    color_dict[c] = to_rgb('gold')
                elif c == 'J':
                    color_dict[c] = to_rgb('indigo')
                elif c == 'K':
                    color_dict[c] = to_rgb('aquamarine')
                elif c == 'L':
                    color_dict[c] = to_rgb('brown')
                elif c == 'M':
                    color_dict[c] = to_rgb('ivory')
                elif c == 'N':
                    color_dict[c] = to_rgb('teal')
                elif c == 'O':
                    color_dict[c] = to_rgb('violet')
                elif c == 'P':
                    color_dict[c] = to_rgb('purple')
                elif c == 'Q':
                    color_dict[c] = to_rgb('coral')
                elif c == 'R':
                    color_dict[c] = to_rgb('olive')
                elif c == 'S':
                    color_dict[c] = to_rgb('royalblue')
                elif c == 'T':
                    color_dict[c] = to_rgb('cyan')
                elif c == 'V':
                    color_dict[c] = to_rgb('deeppink')
                elif c == 'W':
                    color_dict[c] = to_rgb('peru')
                elif c == 'X':
                    color_dict[c] = to_rgb('crimson')
                elif c == 'Y':
                    color_dict[c] = to_rgb('maroon')
                elif c == 'Z':
                    color_dict[c] = to_rgb('pink')
